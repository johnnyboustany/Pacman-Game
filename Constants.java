...
public class Constants {
    ...
    public static final int PACMAN_STARTING_COL = 11; // (UNITS: pixels)

    public static final int BLINKY_STARTING_ROW = 8; // (UNITS: pixels)
    public static final int BLINKY_STARTING_COL = 11; // (UNITS: pixels)

    public static final int PINKY_STARTING_ROW = 10; // (UNITS: pixels)
    public static final int PINKY_STARTING_COL = 10; // (UNITS: pixels)
    ...
    public static final int INKY_STARTING_ROW = 10; // (UNITS: pixels)
    public static final int INKY_STARTING_COL = 11; // (UNITS: pixels)

    public static final int CLYDE_SHIFTED= 1; // (UNITS: pixels)
    ...
    public static final double CHASE_MODE_DURATION = 20; // (s)
    public static final double FRIGHTENED_MODE_DURATION = 8; // (s)

    public static final double GHOST_PEN_RELEASE_DURATION = 2.5; // (s)


    public static final int GAME_IS_OVER_FONT_SIZE = 40;
    public static final int GAME_IS_OVER_X= 235; // (UNITS: pixels)
    public static final int GAME_IS_OVER_Y= 300; // (UNITS: pixels)


    public static final int LIVES_SCORE_FONT_SIZE = 14;
